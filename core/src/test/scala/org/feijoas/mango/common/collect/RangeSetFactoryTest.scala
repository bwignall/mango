 ...
 *  @since 0.8
 */
class RangeSetFactoryTest extends AnyFreeSpec {
  "RangeSetFactory" - {
...
private[mango] object DummyRangeSetFactory extends RangeSetFactory[RangeSet] {
  def newBuilder[C, O <: Ordering[C]](implicit ord: O): Builder[Range[C, O], RangeSet[C, O]] =
    ImmutableRangeSetWrapper.newBuilder[C, O]
}
