...
object DiscreteDomain {
   ...
   */
  @SerialVersionUID(1L)
  implicit object IntDomain extends DiscreteDomain[Int] with Serializable {
  ...
  @SerialVersionUID(1L)
  implicit private[mango] object BigIntDomain extends DiscreteDomain[BigInt] with Serializable {
